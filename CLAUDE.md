...
**Documentation index**: [`doc/README.md`](doc/README.md) (product, design, client/server architecture). **Core logic & flowcharts**: [`doc/core/`](doc/core/). **Module topics**: [`doc/core/modules/`](doc/core/modules/). Living API deltas: [`lwh/code_changed/`](lwh/code_changed/). Historical Phase specs are archived under `doc/archive/` — do not treat as source of truth.
